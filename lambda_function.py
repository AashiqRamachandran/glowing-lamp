...
#         "Host": "i00trfiv2d.execute-api.us-east-1.amazonaws.com",
#         "Postman-Token": "49cdef4d-3d43-47e0-b4d3-786231faa1f9",
#         "User-Agent": "PostmanRuntime/7.29.2",
#         "X-Amzn-Trace-Id": "Root=1-6311ef9c-4c0d668e24b81e312649cb79",
#         "X-Forwarded-For": "49.37.219.168",
...
#         ],
#         "Host": [
#             "i00trfiv2d.execute-api.us-east-1.amazonaws.com"
#         ],
#         "Postman-Token": [
#             "49cdef4d-3d43-47e0-b4d3-786231faa1f9"
#         ],
#         "User-Agent": [
#             "PostmanRuntime/7.29.2"
#         ],
#         "X-Amzn-Trace-Id": [
#             "Root=1-6311ef9c-4c0d668e24b81e312649cb79"
#         ],
#         "X-Forwarded-For": [
#             "49.37.219.168"
#         ],
...
#     "requestContext": {
#         "resourceId": "wm2mub",
#         "resourcePath": "/{app}/{action}",
#         "httpMethod": "GET",
#         "extendedRequestId": "X1JggEwfoAMFewA=",
#         "requestTime": "02/Sep/2022:11:57:16 +0000",
#         "path": "/v1/splunk/query/",
#         "accountId": "259881173586",
#         "protocol": "HTTP/1.1",
#         "stage": "v1",
#         "domainPrefix": "i00trfiv2d",
#         "requestTimeEpoch": 1662119836699,
#         "requestId": "51863821-cc65-4458-94c0-18c36ee7b701",
#         "identity": {
#             "cognitoIdentityPoolId": None,
#             "accountId": None,
#             "cognitoIdentityId": None,
#             "caller": None,
#             "sourceIp": "49.37.219.168",
#             "principalOrgId": None,
#             "accessKey": None,
...
#             "user": None
#         },
#         "domainName": "i00trfiv2d.execute-api.us-east-1.amazonaws.com",
#         "apiId": "i00trfiv2d"
#     },
#     "body": """
...
#
# Key Target Sectors: Information Technology, Government, Military, Energy and Power, Communication, Transportation, Financial Services, Educational System
#
...
# Overview
#
# APT34 is an Advanced Persistent Threat (APT) group, active since  2014. This group works on behalf of the Iranian government and has been observed targeting victims mostly across the Middle Eastern region. They have targeted a variety of industries, including financial, government, energy, chemical, and telecommunications, and has primarily focused its operations within the Middle East. This adversary was originally identified and tracked as two separate groups, OilRig and APT34. But further research and evidence revealed an overlap between their activities, and eventually, most researchers agreed to track them as a single Threat Actor. Most recently in mid-2019, Turla (Cyber-espionage group from Russia) hijacked the Infrastructure of this APT, in one of their attack campaigns.
#
...
# In April 2019, information leaked by elite hackers “Lab Dookhtegan” and “Mr_L4nnist3r” revealed the victim’s names as the Saudi Arabian Communications & Information Technology Commission, Dubai Statistics Association.
...
#
# This group is known to use various malware and tools to collect strategic information that would benefit the economic and geopolitical interests of the state of Iran. Also, Iran considers cyber-attacks as an offensive weapon against its rival countries like the United States of America and Israel. The cyberattacks linked to the group are not that advanced or sophisticated, but highly persistent with their victim choice, which is directly or indirectly connected to Iran’s military, financial, and political interests.
#
# Modus Operandi
#
...
# In early-2017, the group was observed again, using a fake Juniper Networks VPN portal and few fake University of Oxford websites to deliver malware to the victims. The group registered four domain names belonging to Oxford University (including oxford-careers[.]com, oxford[.]in and oxford-employee[.]com).
...
# In Sep. 2017, an analysis done by a security firm on Two-face (web shell) disclosed a complex malicious infrastructure that was targeting Israeli institutions earlier in April. The links between TwoFace and five other web shells were found, including RunningBee, PuTTY Link (plink) and RGDoor (for Microsoft IIS).
...
# In March 2018, the group improved their Critical Infrastructure attacks with new off-the-shelf tools, dual-purpose utilities. They were found to be using earlier unseen malware, that uses SmartFile, Google Drive, and internet server API (ISAPI) filters for compromising Microsoft Internet Information Services (IIS) servers.
# In July 2018, they launched multiple attacks using spearphishing email (having attached PhpSpy and QuadAgent backdoor) to target an unnamed technology services provider, the Lebanese intelligence agency, and healthcare facilities in Saudi Arabia. Their initial infection paths were based on watering hole attacks using compromised web servers. In Sep., they deployed a new variant of their OopsIE Trojan that came with new evasion techniques.
...
# In the same month, a DNSpionage malware campaign was also discovered, using a new malware called 'Karkoff.' The malware was delivered via an Excel document that included malicious macros. They also created a new remote administration tool that supported HTTP and DNS communication.
